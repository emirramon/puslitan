                ...
                <div class="col-md-12">
                    ...
                    <div class="card-content">
                        ...
                        <?php if ($this->session->userdata('level') == '0') : ?>
                            <a href="<?= base_url() ?>Artikel/cetakabsen/<?= $id ?>" target="_blank" rel="tooltip" class="btn btn-success">
                                    ...
                                    <?php foreach ($data_absen as $data) : ?>
                                        ...
                                        <td class="td-actions">
                                            <?php if ($this->session->userdata('level') == '0') : ?>
                                                ...
                                                <a href="<?= base_url() . 'Artikel/deleteabsen/' . $id . '/' . $data['id']; ?>" rel="tooltip" class="btn btn-danger" title="Delete" onClick="if(!confirm(`Apakah Anda Yakin Menghapus <?= $data['id'] ?> ?`)){return false;}">
